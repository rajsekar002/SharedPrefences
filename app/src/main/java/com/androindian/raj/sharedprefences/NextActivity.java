...
public class NextActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String s3=preferences.getString("Useremail","abc@gmail.com");
        String s4=preferences.getString("add","hyd");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.gsignin) {
            ...
            fragmentTransaction.replace(R.id.frame,googlesignin);
            ...
            /*FragmentTransaction fragmentTransaction=
                    getFragmentManager().beginTransaction();
            MapsGoogle mapsGoogle=new MapsGoogle();
            fragmentTransaction.replace(R.id.frame,mapsGoogle);
            fragmentTransaction.commit();*/
